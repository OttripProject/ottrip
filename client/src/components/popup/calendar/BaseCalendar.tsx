...
function DefaultDayCell({
  ...
  const isToday =
    showToday && dayjs().isSame(dayjs(date.dateString), "day") && !isSelected;
...
export default function BaseCalendar({
  ...
  const [isOpen, setIsOpen, handleOutsidePress] = useDetectClose(
    calendarRef,
    visible,
  );
  ...
  const handleConfirm = () => {
    if (view === "day") {
      ...
      if (tempSelectedYear !== null) {
        ...
        const newDate = dayjs(
          `${tempSelectedYear}-${currentMonthIndex + 1}-01`,
        );
        setCurrentMonth(newDate.format("YYYY-MM-DD"));
        setView("month");
      }
  ...
  const renderMonthPicker = () => {
    ...
    const selectedMonthIndex =
      tempSelectedMonth !== null ? tempSelectedMonth : currentMonthIndex;
  ...
  const renderYearPicker = () => {
    ...
    const selectedYear =
      tempSelectedYear !== null ? tempSelectedYear : currentYear;
                ...
                >
                  <Text
                    style={[
                      ...
                      isCurrentYear &&
                        !isSelected &&
                        styles.yearPickerItemTextCurrent,
              ...
              theme={
                {
                  ...
                  todayBackgroundColor: showToday
                    ? colors.primary
                    : "transparent",
