        ...
        <View style={styles.fieldPickerWrap}>
          <>
            ...
            <TimeModal
              ...
              onConfirm={t => { setStartTime(t); setStartTimeVisible(false); }}
            />
          </>
        </View>
      </View>
        ...
        <View style={styles.fieldPickerWrap}>
          <>
            ...
            <TimeModal
              ...
              value={endTime || "09:00"}
              onConfirm={t => { setEndTime(t); setEndTimeVisible(false); }}
            />
          </>
        </View>
      </View>
...
>(function FlightDraftEditor({ draft }, ref) {
  ...
  const [segmentDepTimeVisible, setSegmentDepTimeVisible] = useState<number | null>(null);
  const [segmentArrTimeVisible, setSegmentArrTimeVisible] = useState<number | null>(null);
                ...
                <View style={styles.fieldPickerWrap}>
                  <>
                    ...
                    <TimeModal
                      ...
                      onClose={() => setSegmentDepTimeVisible(null)}
                      value={segment.departure_time || "09:00"}
                      onConfirm={t => {
                        const next = [...segments];
                        next[idx] = { ...next[idx], departure_time: t };
                        setSegments(next);
                        setSegmentDepTimeVisible(null);
                      }}
                    />
                  </>
                </View>
                ...
                <View style={styles.fieldPickerWrap}>
                  <>
                    ...
                    <TimeModal
                      ...
                      onClose={() => setSegmentArrTimeVisible(null)}
                      value={segment.arrival_time || "09:00"}
                      onConfirm={t => {
                        const next = [...segments];
                        next[idx] = { ...next[idx], arrival_time: t };
                        setSegments(next);
                        setSegmentArrTimeVisible(null);
                      }}
                    />
                  </>
                </View>
        ...
        <View style={styles.fieldPickerWrap}>
          <>
            ...
            <TimeModal
              ...
              onClose={() => setCheckinTimeVisible(false)}
              value={checkinTime || "09:00"}
              onConfirm={t => { setCheckinTime(t); setCheckinTimeVisible(false); }}
            />
          </>
        </View>
      </View>
        ...
        <View style={styles.fieldPickerWrap}>
          <>
            ...
            <TimeModal
              ...
              onClose={() => setCheckoutTimeVisible(false)}
              value={checkoutTime || "09:00"}
              onConfirm={t => { setCheckoutTime(t); setCheckoutTimeVisible(false); }}
            />
          </>
        </View>
      </View>
